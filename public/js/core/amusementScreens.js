...
export function createAmusementScreens(deps) {
  const { ansiToHTML, applyCommandFooter, buildBiorhythmIntroAnsi, buildBiorhythmAnsi, buildFortuneIntroAnsi, buildFortuneAnsi, buildMbtiListAnsi, buildMbtiDetailAnsi, buildRetroArtListAnsi, buildRetroArtViewAnsi, findMbtiType, cmdInput, getCommandFooterText, getMenuNodeByKey, renderScreenSequential, screenEl, setHint, setPrompt, state, updateURL, displayWidth } = deps;
