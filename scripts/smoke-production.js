...
const checks = [
  ...
  { path: '/api/memos/1/read', method: 'PATCH', body: '{}', statuses: [401], label: 'memo read PATCH auth boundary', safeResponse: true },
  { path: '/api/memos/1', statuses: [401], label: 'memo detail auth boundary', safeResponse: true },
  { path: '/api/memos/1/archive', method: 'POST', body: '{"archived":true}', statuses: [401], label: 'memo archive auth boundary', safeResponse: true },
  { path: '/api/memos/1', method: 'DELETE', body: '{}', statuses: [401], label: 'memo delete auth boundary', safeResponse: true },
  ...
  { path: '/api/members/absent', method: 'POST', body: '{}', statuses: [401], label: 'member absence write auth boundary', safeResponse: true },
  { path: '/api/members/stats', statuses: [401], label: 'member stats auth boundary', safeResponse: true },
  { path: '/api/members/profile', method: 'POST', body: '{}', statuses: [401], label: 'member profile auth boundary', safeResponse: true },
  { path: '/api/members/guest', method: 'DELETE', body: '{}', statuses: [401], label: 'member delete auth boundary', safeResponse: true },
  { path: '/api/members/guest/password/verify', method: 'POST', body: '{}', statuses: [401], label: 'password verify auth boundary', safeResponse: true },
  { path: '/api/members/guest/email', method: 'POST', body: '{}', statuses: [401], label: 'member email auth boundary', safeResponse: true },
  { path: '/api/members/guest/password', method: 'POST', body: '{}', statuses: [401], label: 'member password auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts', method: 'POST', body: '{}', statuses: [401], label: 'post create auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts/1/reply', method: 'POST', body: '{}', statuses: [401], label: 'post reply auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts/1/recommend', method: 'POST', body: '{}', statuses: [401], label: 'post recommend auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts/1', method: 'PATCH', body: '{}', statuses: [401], label: 'post update auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts/1', method: 'DELETE', body: '{}', statuses: [401], label: 'post delete auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts/1/attachments', method: 'POST', body: '{}', statuses: [401], label: 'attachment create auth boundary', safeResponse: true },
  { path: '/api/boards/plaza/posts/1/attachments/1', method: 'DELETE', body: '{}', statuses: [401], label: 'attachment delete auth boundary', safeResponse: true },
  ...
  { path: '/api/chat/rooms/1/kick', method: 'POST', body: '{}', statuses: [401], label: 'chat kick auth boundary', safeResponse: true },
  { path: '/api/chat/rooms/1/settings', method: 'POST', body: '{}', statuses: [401], label: 'chat settings auth boundary', safeResponse: true },
  { path: '/api/conf/rooms', method: 'POST', body: '{}', statuses: [401], label: 'conf room create auth boundary', safeResponse: true },
  { path: '/api/conf/rooms/1/close', method: 'POST', body: '{}', statuses: [401], label: 'conf room close auth boundary', safeResponse: true },
  { path: '/api/conf/rooms/1/agendas', method: 'POST', body: '{}', statuses: [401], label: 'conf agenda create auth boundary', safeResponse: true },
  { path: '/api/conf/agendas/1/second', method: 'POST', body: '{}', statuses: [401], label: 'conf agenda second auth boundary', safeResponse: true },
  { path: '/api/votes', method: 'POST', body: '{}', statuses: [401], label: 'vote create auth boundary', safeResponse: true },
  { path: '/api/votes/1/cast', method: 'POST', body: '{}', statuses: [401], label: 'vote cast auth boundary', safeResponse: true },
  { path: '/api/votes/1', method: 'DELETE', body: '{}', statuses: [401], label: 'vote delete auth boundary', safeResponse: true },
  { path: '/api/system/info', statuses: [401, 403], label: 'system info admin boundary', safeResponse: true },
