...
const CHECKS = [
  ...
  { name: 'supabase-security', file: 'smoke-supabase-security-contract.js' },
  ...
  { name: 'screen-action-contract', file: 'smoke-screen-action-contract.js' },
  { name: 'action-parity', file: 'smoke-action-parity.mjs' },
  { name: 'memo-contact-parity', file: 'smoke-memo-contact-parity.mjs' },
  { name: 'go-ansi', file: 'smoke-go-ansi.js' },
